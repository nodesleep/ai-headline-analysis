    ...
    try {
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an AI that generates detailed and structured analyses of news articles based on their headlines. Return the response strictly in the following JSON format:"
                },
                {
                    role: "system",
